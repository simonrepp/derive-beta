...
module.exports = {
  ...
  async registerPlugin() {
    const commands = {
      'derive-beta:backup': () => backup(this.data),
      'derive-beta:deploy-berlin.urbanize.at': () => update(this.data, 'berlin.urbanize.at', true),
      ...
      'derive-beta:deploy-staging.berlin.urbanize.at': () => update(this.data, 'staging.berlin.urbanize.at'),
      ...
      'derive-beta:preview-berlin.urbanize.at': () => preview(this.data, 'berlin.urbanize.at'),
