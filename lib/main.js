...
module.exports = {
            ...
            for(let directory of projectFolders) {
                ...
                if(fs.existsSync(configPath)) {
                    ...
                    for(const element of config.elements()) {
                        if (!element.yieldsSection()) { continue; }

                        const siteSection = element.toSection();
    ...
    async registerPlugin() {
        const commands = {
            'derive-beta:analysis-bibliography': () => analysis.bibliography(this.data),
            'derive-beta:analysis-general': () => analysis.general(this.data),
