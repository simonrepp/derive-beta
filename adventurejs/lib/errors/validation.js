...
// TODO: Look into getting ranges() recursively on error reporting in some AdventureSection (eg.) methods
...
module.exports = {
  ...
  exactCountNotMet: (context, name, instructions, expectedCount, sectionInstruction) => {
    ...
    throw new AdventureValidationError(message, snippet, selection);

    // throw new AdventureValidationError(this.context, {
  ...
  fabricateValueError: (context, message, valueInstruction) => {
    ...
    return new AdventureValidationError(messageProcessed, snippet, selection);
