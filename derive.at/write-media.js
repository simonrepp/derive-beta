...
module.exports = async data => {
  ...
  for(let article of data.articles.values()) {
    if(article.image && !article.image.written) {
    ...
    if(article.text && !article.text.written) {
  ...
  for(let book of data.books.values()) {
    if(book.cover && !book.cover.written) {
  ...
  for(let event of data.events.values()) {
    if(event.image && !event.image.written) {
    ...
    if(event.text && !event.text.written) {
  ...
  for(let issue of data.issues.values()) {
    if(issue.cover && !issue.cover.written) {
  ...
  for(let program of data.programs.values()) {
    if(program.image && !program.image.written) {
    ...
    if(program.soundfile && !program.soundfile.written) {
    ...
    if(program.text && !program.text.written) {
