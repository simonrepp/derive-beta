// const PlainDumper = require('./lib/dumper.js');
const PlainParser = require('./lib/parser.js');
const { PlainParseError, PlainValidationError } = require('./lib/errors.js');
...
//   const dumper = new PlainDumper(input, locale);
};
...
exports.parse = (input, locale = 'en') => {
  ...
  const parser = new PlainParser(input, locale);

  return parser.run();
};

exports.PlainParseError = PlainParseError;
exports.PlainValidationError = PlainValidationError;
